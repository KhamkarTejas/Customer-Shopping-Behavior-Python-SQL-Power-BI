...
- Support data-driven marketing and product strategies
...
- Product details (Category, Item Purchased, Size, Color)
- Transaction details (Purchase Amount, Season, Payment Method)
...
- Top-rated products often align with best-selling items
...
- **Apply Targeted Marketing** based on customer demographics and behavior
...
📌 Open to opportunities in **Data Analyst / BI roles**

---

## ⭐ Acknowledgements
This project was created for learning, practice, and portfolio development in data analytics.
